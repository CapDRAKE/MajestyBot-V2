...
module.exports = {
  ...
  async execute({ client, message, args }) {
    ...
    if (!args.length) return message.reply("Precise le nom du serveur. Ex: `+serverrestart Survie`");
    ...
    try {
      await api.restart10(apiKey, found.id, "restart10");
      await message.reply("🔄 **Redemarrage** de **" + found.name + "** envoye.");
    } catch (e) {
