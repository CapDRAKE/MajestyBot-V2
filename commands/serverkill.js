...
module.exports = {
  ...
  async execute({ client, message, args }) {
    ...
    if (!args.length) return message.reply("Precise le nom du serveur. Ex: `+serverkill Survie`");
    ...
    try {
      await api.kill(apiKey, found.id, "kill");
      await message.reply("💀 **Kill force** de **" + found.name + "** envoye.");
    } catch (e) {
